...
class Product(models.Model):
    ...
    image = models.ImageField(max_length=100, verbose_name = 'Изображение продукта', upload_to='img', blank=True, null=True)
...
class Comment(models.Model):
    ...
    author = models.CharField(verbose_name='Автор комментария', max_length=100)
...
class Order(models.Model):
    product_fk = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name = "Продукт")
    ...
    order_num = models.CharField(max_length = 20, verbose_name = "Код заказа", blank=True, null=True)
